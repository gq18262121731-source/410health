...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--root",
        type=Path,
        default=Path(r"D:\Program\410health_new\health1\data\fall_eval"),
    ...
    parser.add_argument(
        ...
        "--output",
        type=Path,
        default=Path(r"D:\Program\410health_new\health1\data\fall_eval\fall_eval_manifest.json"),
    )
    parser.add_argument(
        "--review-frames",
        type=Path,
        default=Path(r"D:\Program\410health_new\health1\data\fall_media_demo\review_frames"),
