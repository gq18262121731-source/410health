...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pose-model", type=Path, default=ROOT / "fall_detection_model_bundle" / "yolo11n-pose.pt")
    parser.add_argument("--tcn-weights", type=Path, default=ROOT / "fall_detection_model_bundle" / "weights" / "pose_tcn_fall_v2.pt")
