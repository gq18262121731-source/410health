...
USAGE = (
    ...
    + "|   llamafactory-cli export -h: merge adapters and export model      |\n"
    + "|   llamafactory-cli train -h: train domain models                   |\n"
    + "|   llamafactory-cli webchat -h: launch the model chat console       |\n"
    + "|   llamafactory-cli webui: launch the model tuning console          |\n"
    + "|   llamafactory-cli env: show environment info                      |\n"
    + "|   llamafactory-cli version: show version info                      |\n"
    + "| Hint: Use the console from the AIoT Care Console tuning page.      |\n"
    + "-" * 70
)
...
def launch():
    ...
    WELCOME = (
        "-" * 58
        + "\n"
        + f"| AIoT Care Model Tuning Console, version {VERSION}"
        + " " * (21 - len(VERSION))
        + "|\n|"
        + " " * 56
        + "|\n"
        + "| Project page: AIoT Care Console internal workspace     |\n"
        + "-" * 58
    )
