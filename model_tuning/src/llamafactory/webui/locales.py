...
LOCALES = {
    "title": {
        "en": {
            "value": (
                "<section class='health-branding'><p class='health-branding__eyebrow'>AIoT Care Console</p>"
                "<h1>智慧康养模型微调中心</h1>"
                "<p>选择基础模型、领域数据和训练参数，完成训练、评估、对话验证与模型导出。</p></section>"
            ),
        },
        "ru": {
            "value": (
    ...
    "subtitle": {
        "en": {
            "value": (
                "<div class='health-branding-links'>"
                "<span>训练</span><span>评估预测</span><span>模型对话</span><span>模型导出</span>"
                "</div>"
            ),
        },
        "ru": {
